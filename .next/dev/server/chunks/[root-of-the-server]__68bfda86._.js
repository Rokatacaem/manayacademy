...
;
;
const { auth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2e$config$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["default"]);
const config = {
    matcher: [
...
const __TURBOPACK__default__export__ = auth(async function middleware(req) {
    ...
    if (path.startsWith('/admin')) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].rewrite(new URL(`/tenant/${DEFAULT_SLUG}${path}`, req.url));
    }
